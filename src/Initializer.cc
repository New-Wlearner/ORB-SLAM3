...
bool Initializer::ReconstructF(vector<bool> &vbMatchesInliers,  // 利用F或者H矩阵验证后的inliers
                               cv::Mat &F21, 
                               cv::Mat &K,
                               cv::Mat &R21, 
                               cv::Mat &t21, 
...
// ! 知识点E分解得到UAVt   U的最后一列是t,归一化,构造W矩阵 得到R1和R2 参考计算机视觉中的多视图几何
